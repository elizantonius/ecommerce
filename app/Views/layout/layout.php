...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/admin/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/admin/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
    <!-- BS Stepper -->
    <link rel="stylesheet" href="<?= base_url() ?>/admin/plugins/bs-stepper/css/bs-stepper.min.css">
    <!-- dropzonejs -->
    <link rel="stylesheet" href="<?= base_url() ?>/admin/plugins/dropzone/min/dropzone.min.css">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/index.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v1</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/index2.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v2</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/index3.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v3</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/starter.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Starter Page</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/admin/iframe.html" class="nav-link">
    ...
    <script src="<?= base_url() ?>/admin/plugins/angular/angular.min.js"></script>
    <script src="<?= base_url() ?>/apps/apps.js"></script>
    <script src="<?= base_url() ?>/apps/controllers/admin.controllers.js"></script>
    <script src="<?= base_url() ?>/apps/services/admin.services.js"></script>
    <script src="<?= base_url() ?>/apps/services/auth.services.js"></script>
    <script src="<?= base_url() ?>/apps/services/helper.services.js"></script>
